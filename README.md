...
* [certbot](https://github.com/certbot/certbot) ⭐ 33,211 | 🐛 187 | 🌐 Python | 📅 2026-08-21 - Previously the Let's Encrypt Client, is EFF's tool to obtain certs from Let's Encrypt, and (optionally) auto-enable HTTPS on your server. It can also act as a client for any other CA that uses the ACME protocol.
* [sops](https://github.com/mozilla/sops) ⭐ 22,913 | 🐛 443 | 🌐 Go | 📅 2026-08-24 - sops is an editor of encrypted files that supports YAML, JSON and BINARY formats and encrypts with AWS KMS, GCP KMS, Azure Key Vault and PGP.
...
* [git-crypt](https://github.com/AGWA/git-crypt) ⭐ 9,867 | 🐛 128 | 🌐 C++ | 📅 2025-09-24 - Transparent file encryption in git.
...
* [OpenSSL](https://github.com/openssl/openssl) ⭐ 30,675 | 🐛 1,539 | 🌐 C | 📅 2026-08-24 - TLS/SSL and crypto library.
...
* [wolfSSL](https://github.com/wolfSSL/wolfssl) ⭐ 2,918 | 🐛 194 | 🌐 C | 📅 2026-08-25 - Small, fast, portable implementation of TLS/SSL for embedded devices to the cloud.
...
* [cryptopp](https://github.com/weidai11/cryptopp) ⭐ 5,493 | 🐛 65 | 🌐 C++ | 📅 2026-08-05 - Crypto++ Library is a free C++ class library of cryptographic schemes.
...
* [cryptol](https://github.com/GaloisInc/cryptol) ⭐ 1,218 | 🐛 263 | 🌐 Haskell | 📅 2026-08-24 - The Language of Cryptography.
...
* [sjcl](https://github.com/bitwiseshiftleft/sjcl) ⭐ 7,200 | 🐛 117 | 🌐 JavaScript | 📅 2026-03-18 - Stanford JavaScript Crypto Library.
...
* [forge](https://github.com/digitalbazaar/forge) ⭐ 5,329 | 🐛 461 | 🌐 JavaScript | 📅 2026-03-25 - Native implementation of TLS in JavaScript and tools to write crypto-based and network-heavy webapps.
...
* [Keycloak](https://github.com/keycloak/keycloak) ⭐ 36,391 | 🐛 3,120 | 🌐 Java | 📅 2026-08-25 - Open Source Identity and Access Management For Modern Applications and Services.
...
* [Google Tink](https://github.com/tink-crypto/tink-java) ⭐ 299 | 🐛 13 | 🌐 Java | 📅 2026-08-24 - A small crypto library that provides a safe, simple, agile and fast way to accomplish some common crypto tasks.
...
* [rustls](https://github.com/ctz/rustls) ⭐ 7,584 | 🐛 85 | 🌐 Rust | 📅 2026-08-24 - Rustls is a new, modern TLS library written in Rust.
* [BLAKE3](https://github.com/BLAKE3-team/BLAKE3) ⭐ 6,390 | 🐛 196 | 🌐 Assembly | 📅 2026-08-20 - is official Rust and C implementations of the BLAKE3 cryptographic hash function.
* [ockam](https://github.com/ockam-network/ockam) ⭐ 4,632 | 🐛 93 | 🌐 Rust | 📅 2026-01-04 - is a Rust library for end-to-end encryption and mutual authentication.
...
* [rage](https://github.com/str4d/rage) ⭐ 3,630 | 🐛 64 | 🌐 Rust | 📅 2026-08-20 - is a simple, modern, and secure file encryption tool, using the age format.
